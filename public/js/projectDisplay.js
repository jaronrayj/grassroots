$(document).ready(function () {
  ...
  function displayInfo(row, project) {
    for (let i = offset; i < offset + 3; i++) {
      ...
      let button = $("<button>").addClass("btn moreInfo btn-default viewBtn").attr("data-project", project[i].id).text("Find out more!").data("toggle", "modal").data("target", "#projectModal");
